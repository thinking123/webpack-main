...
class LazyCompilationProxyModule extends Module {
	...
	/** LazyCompilationDependency -> LazyCompilationDependencyFactory -> 返回 originalModule 重新编译原来代理的 module
...
class LazyCompilationPlugin {
	...
	apply(compiler) {
		...
		compiler.hooks.beforeCompile.tapAsync(
			...
			(params, callback) => { // 启动 http server
				if (backend !== undefined) return callback();
				const promise = this.backend(compiler, (err, result) => {
					if (err) return callback(err);
					backend = result; // {dispose , module}
					callback();
				});
				...
				normalModuleFactory.hooks.module.tap(
					...
					(originalModule, createData, resolveData) => {
						if (
							...
							!/webpack-main[/\\]hot[/\\]|webpack-dev-server[/\\]client/.test(
								resolveData.request
							) &&
							checkTest(this.test, originalModule)
						) {//data: '/Users/a/github/webpack-main/webpack-test/lazy-compilation/index.js'
							const moduleInfo = backend.module(originalModule);
							if (!moduleInfo) return;
							const { client, data, active } = moduleInfo;
							// client:/Users/a/github/webpack-main/hot/lazy-compilation-web.js?http%3A%2F%2Flocalhost%3A58124%2Flazy-compilation-using-
...
// var client = __webpack_require__(/*! ../../../../webpack-main/hot/lazy-compilation-web.js?http%3A%2F%2Flocalhost%3A54656%2Flazy-compilation-using- */ "../../../../webpack-main/hot/lazy-compilation-web.js?http%3A%2F%2Flocalhost%3A54656%2Flazy-compilation-using-")
// var data = "/Users/a/github/zstack/local-test/src/reactjs/index.js";
// module.exports = __webpack_require__.e(/*! import() */ "index_js").then(__webpack_require__.bind(__webpack_require__, /*! ./index.js */ "./index.js"));
// if (module.hot) {
// 	module.hot.accept();
// 	module.hot.accept("./index.js", function() { module.hot.invalidate(); });
// 	module.hot.dispose(function(data) { delete data.resolveSelf; dispose(data); });
// 	if (module.hot.data && module.hot.data.resolveSelf) module.hot.data.resolveSelf(module.exports);
// }
// function onError() { /* ignore */ }
...
// var data = "/Users/a/github/zstack/local-test/node_modules/babel-loader/lib/index.js%3F%3FruleSet%5B1%5D.rules%5B1%5D.use!/Users/a/github/zstack/local-test/src/reactjs/index.js";
// module.exports = __webpack_require__.e(/* import() */ 157).then(__webpack_require__.bind(__webpack_require__, 157));
// if (module.hot) {
// 	module.hot.accept();
// 	module.hot.accept(157, function() { module.hot.invalidate(); });
// 	module.hot.dispose(function(data) { delete data.resolveSelf; dispose(data); });
// 	if (module.hot.data && module.hot.data.resolveSelf) module.hot.data.resolveSelf(module.exports);
// }
// function onError() { /* ignore */ }
