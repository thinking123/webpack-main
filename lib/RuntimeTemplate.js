...
class RuntimeTemplate {
	 ...
	 */
	moduleId({ module, chunkGraph, request, weak }) { // /*! ./commonjs/common1 */ "./webpack-test/src/commonjs/common1.js"
		if (!module) {
	...
	importStatement({
		...
		}// moduleId === '/*! webpack/hot/log.js */ "../../../../webpack-main/hot/log.js"'
		const moduleId = this.moduleId({
			module,
			chunkGraph,
			request,
		...
		if (exportsType === "dynamic") {
			...
			return [
				importContent,// === '/* harmony import */ var webpack_hot_log_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! webpack/hot/log.js */ "../../../../webpack-main/hot/log.js");\n'
