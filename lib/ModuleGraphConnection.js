...
class ModuleGraphConnection {
	...
	constructor(
		...
		this.resolvedOriginModule = originModule; // 依赖的原始 module
		this.dependency = dependency;
		this.resolvedModule = module; // dep 对应的module ，import b from './b' ./b 对应的 module
		this.module = module;
		this.weak = weak;
		//是否需要条件判断 isActive , condition === true
