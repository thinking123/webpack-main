...
class HarmonyImportDependency extends ModuleDependency {
	...
	/** var _index_less__WEBPACK_IMPORTED_MODULE_0__
	...
	getImportVar(moduleGraph) {
		...
		importVar = `${Template.toIdentifier(
			`${this.userRequest}`
		)}__WEBPACK_IMPORTED_MODULE_${importVarMap.size}__`; // 导入module 的  顺序 var _index_less__WEBPACK_IMPORTED_MODULE_0__ = import()
