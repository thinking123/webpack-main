...
class HarmonyImportSpecifierDependency extends HarmonyImportDependency {
	...
	getReferencedExports(moduleGraph, runtime) {
		...
		return [ids]; // import {usedFunction} from 'xx' , export {usedFunction , xxx} , ids = [usedFunction]
	}
	...
	apply(dependency, source, templateContext) {
		...
		if (
			...
			const { runtimeTemplate, initFragments, runtimeRequirements } =
				templateContext;
				// '(0,_util_util_export__WEBPACK_IMPORTED_MODULE_0__["default"])'
		...
		} else {//';(0,_util_util_export__WEBPACK_IMPORTED_MODULE_0__.fun1)'
			source.replace(dep.range[0], dep.range[1] - 1, exportExpr);//'(0,_utils_parseURL_js__WEBPACK_IMPORTED_MODULE_2__["default"])'
		}
	}
};
