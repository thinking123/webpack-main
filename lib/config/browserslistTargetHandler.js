...
const load = (input, context) => {
	...
	return browserslist(config); //返回支持的 浏览器 数组 === ['chrome 97', 'firefox 96' ] 从 browserslist config获取
};

/** 返回支持的 js function
 * @param {string[]} browsers supported browsers list 支持的 浏览器 数组 === ['chrome 97', 'firefox 96' ]
