...
class JavascriptGenerator extends Generator {
	...
	sourceModule(module, initFragments, source, generateContext) {
		for (const dependency of module.dependencies) {//HarmonyImportSideEffectDependency,HarmonyImportSpecifierDependency
	...
	sourceDependency(module, dependency, initFragments, source, generateContext) {
		...
		template.apply(dependency, source, templateContext); // dep template 生成代码 ， 插入到source
