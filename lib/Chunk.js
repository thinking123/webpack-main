...
const ChunkFilesSet = createArrayToSetDeprecationSet("chunk.files"); //  === Set
...
class Chunk {
	...
	/**chunk 属于 entryPoint 和 chunkGroup
	...
	split(newChunk) {
		for (const chunkGroup of this._groups) {
			//插入 newChunk 在 this chunk 之前 ，到 chunkGroup
