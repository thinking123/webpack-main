...
class WeakTupleMap {
	 ...
	 * @returns {void}
	 */
	set(...args) { // args = [arg1 , arg2 , arg3] => WeakTupleMap.w|m = map(arg1 , WeakTupleMap.w = (arg2 , WeakTupleMap.w|m = (arg3 , WeakTupleMap.v = arg3))) , args 是按照链表存储的 ： WeakTupleMap.w|m  === map , w 存储object，m 存储非object (包括function)
