...
Caller might not support runtime-dependent code generation (opt-out via optimization.usedExports: "global").`
	...
	/** 计算 module   和 依赖的 module exports 的 hash
	 * @param {Module} module the module
	 * @param {RuntimeSpec} runtime the runtime
	...
	_getModuleGraphHashWithConnections(cgm, module, runtime) {
		...
		return cgm.graphHashesWithConnections.provide(runtime, () => {
			const graphHash = this._getModuleGraphHashBigInt( // 计算 module exports hash
				cgm,
				module,
				runtime
			).toString(16);
			const connections = this.moduleGraph.getOutgoingConnections(module);// 计算OutgoingConnections 对应的module （依赖的module），  module exports hash
			/** @type {Set<Module>} */
