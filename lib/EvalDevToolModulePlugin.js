		...
		compiler.hooks.compilation.tap("EvalDevToolModulePlugin", compilation => {
			...
			hooks.renderModuleContent.tap(
				...
				(source, module, { runtimeTemplate, chunkGraph }) => {
					...
					const str = ModuleFilenameHelpers.createFilename( // moduleFilenameTemplate ('webpack://[namespace]/[resourcePath]?[loaders]') 获取文件 module sourcemap name ， 'webpack://webpack/./webpack-test/src/main.js?'
						module,
						{
