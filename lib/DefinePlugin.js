...
class DefinePlugin {
	 ...
	 */
	apply(compiler) {
		const definitions = this.definitions; //{process.env.NODE_ENV: [production | development]}
			...
			(compilation, { normalModuleFactory }) => {
				...
				const handler = parser => {
					...
					parser.hooks.program.tap("DefinePlugin", () => {
						...
						buildInfo.valueDependencies.set(VALUE_DEP_MAIN, mainValue);//'webpack/DefinePlugin_hash'
					});
